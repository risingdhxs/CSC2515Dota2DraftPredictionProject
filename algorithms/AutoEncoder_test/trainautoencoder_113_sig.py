def trainautoencoder_113_sig(layer, set):
    import warnings
    ...
    from autoencoder_113_sig import autoencoder
    ...
    print('Training Sig AutoEncoder of {}. Training set size:{}, batch size:{}'.format(nodenum, TrainXae.shape[0], batch_size))
    ...
    print('On {} dataset, optimal {} Sigmoid AE T/V/T loss: {:.4f}/{:.4f}/{:.4f}'.format(set, nodenum, loss_train,
                                                                                          loss_valid, loss_test))
