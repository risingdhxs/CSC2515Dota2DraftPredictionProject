...
OUTPUT_EXT='_lr0.0001_113_50_25_50_50_1_noleave_N'
...
class Config(object):
    ...
    def __str__(cls):
        return "Neural Network with five layers: {}, {}, {}, {}, {}. Learning rate: {}, epochs: {}".format(
            cls.S1, cls.S2, cls.C1, cls.C2, cls.D_out, cls.learning_rate, cls.epochs_size
        )
